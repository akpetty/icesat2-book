...
<html lang="en" data-content_root="../../../../../../../" >
  ...
  <head>
    ...
    <title>Indexing and Selecting data &#8212; ICESat-2 Sea Ice State Analysis</title>
...
<link rel="preload" as="script" href="../../../../../../../_static/scripts/pydata-sphinx-theme.js?digest=dfe6caa3a7d634c4db9b" />
  <script src="../../../../../../../_static/vendor/fontawesome/6.5.2/js/all.min.js?digest=dfe6caa3a7d634c4db9b"></script>
    ...
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = 'is2book_uv_env/lib/python3.9/site-packages/holoviews/examples/user_guide/10-Indexing_and_Selecting_Data';</script>
...
<div class="dropdown dropdown-launch-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="https://mybinder.org/v2/gh/akpetty/icesat2-book/main?urlpath=tree/is2book_uv_env/lib/python3.9/site-packages/holoviews/examples/user_guide/10-Indexing_and_Selecting_Data.ipynb" target="_blank"
...
<span class="btn__text-container">Repository</span>
      ...
      <li><a href="https://github.com/akpetty/icesat2-book/edit/main/is2book_uv_env/lib/python3.9/site-packages/holoviews/examples/user_guide/10-Indexing_and_Selecting_Data.ipynb" target="_blank"
...
<span class="btn__text-container">Suggest edit</span>
      ...
      <li><a href="https://github.com/akpetty/icesat2-book/issues/new?title=Issue%20on%20page%20%2Fis2book_uv_env/lib/python3.9/site-packages/holoviews/examples/user_guide/10-Indexing_and_Selecting_Data.html&body=Your%20issue%20content%20here." target="_blank"
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../../../_sources/is2book_uv_env/lib/python3.9/site-packages/holoviews/examples/user_guide/10-Indexing_and_Selecting_Data.ipynb" target="_blank"
...
<li class="toc-h1 nav-item toc-entry"><a class="reference internal nav-link" href="#">Indexing and Selecting data</a></li>
<li class="toc-h1 nav-item toc-entry"><a class="reference internal nav-link" href="#indexing-and-slicing-elements">Indexing and slicing Elements</a><ul class="visible nav section-nav flex-column">
<li class="toc-h2 nav-item toc-entry"><a class="reference internal nav-link" href="#d-elements-slicing-and-indexing">1D Elements: Slicing and indexing</a></li>
<li class="toc-h2 nav-item toc-entry"><a class="reference internal nav-link" href="#d-and-3d-elements-slicing">2D and 3D Elements: slicing</a></li>
<li class="toc-h2 nav-item toc-entry"><a class="reference internal nav-link" href="#d-raster-and-image-slicing-and-indexing">2D Raster and Image: slicing and indexing</a></li>
</ul>
</li>
<li class="toc-h1 nav-item toc-entry"><a class="reference internal nav-link" href="#tabular-indexing-and-slicing">Tabular indexing and slicing</a><ul class="visible nav section-nav flex-column">
...
<li class="toc-h2 nav-item toc-entry"><a class="reference internal nav-link" href="#lists-of-integers-and-boolean-indices">Lists of integers and boolean indices</a></li>
</ul>
</li>
...
<li class="toc-h2 nav-item toc-entry"><a class="reference internal nav-link" href="#sampling-elements">Sampling Elements</a></li>
<li class="toc-h2 nav-item toc-entry"><a class="reference internal nav-link" href="#sampling-holomaps">Sampling HoloMaps</a></li>
<li class="toc-h2 nav-item toc-entry"><a class="reference internal nav-link" href="#sampling-charts">Sampling Charts</a></li>
</ul>
</li>
</ul>
...
<div id="searchbox"></div>
  ...
  <section class="tex2jax_ignore mathjax_ignore" id="indexing-and-selecting-data">
<h1>Indexing and Selecting data<a class="headerlink" href="#indexing-and-selecting-data" title="Link to this heading">#</a></h1>
<p>As explained in the <a class="reference internal" href="06-Building_Composite_Objects.html"><span class="std std-doc">Building composite objects</span></a> and <a class="reference internal" href="05-Dimensioned_Containers.html"><span class="std std-doc">Dimensioned Containers</span></a> guides, HoloViews allows building up hierarchical containers that express the natural relationships between data items, in whatever multidimensional space best characterizes the application domain.  Once your data is in such containers, individual visualizations are then made by choosing subregions of this multidimensional space, either smaller numeric ranges (as in cropping of photographic images), or lower-dimensional subsets (as in selecting frames from a movie, or a specific movie from a large library), or both (as in selecting a cropped version of a frame from a specific movie from a large library).</p>
...
<td class="text-center"><p>e[5.5], e[3,5.5]</p></td>
...
<td class="text-center"><p>e[3:5.5], e[3:5.5,0:1]</p></td>
...
<td class="text-center"><p>e.sample(y=5.5),<br>e.sample((3,3))</p></td>
...
<td class="text-center"><p>e.select(y=5.5),<br>e.select(y=(3,5.5))</p></td>
...
<td class="text-center"><p>e[2, :],<br>e[2:5, :]</p></td>
...
<p>These operations are all concerned with selecting some subset of the data values, without combining across data values (e.g. averaging) or otherwise transforming the actual data. In the <a class="reference internal" href="08-Tabular_Datasets.html"><span class="std std-doc">Tabular Data</span></a> user guide we will look at additional operations on the data that reduce, summarize, or transform the data in other ways, in addition to the selections covered here.</p>
...
<section class="tex2jax_ignore mathjax_ignore" id="indexing-and-slicing-elements">
<h1>Indexing and slicing Elements<a class="headerlink" href="#indexing-and-slicing-elements" title="Link to this heading">#</a></h1>
<p>In the <a class="reference internal" href="05-Dimensioned_Containers.html"><span class="std std-doc">Dimensioned Containers</span></a> guide we saw examples of how to select individual elements embedded in a multi-dimensional space.  The <a class="reference internal" href="Continuous_Coordinates.html"><span class="std std-doc">Continuous Coordinates</span></a> user guide covered slicing and indexing in Elements representing continuous coordinate coordinate systems such as <code class="docutils literal notranslate"><span class="pre">Image</span></code> types. Here we’ll be going through each operation in full detail, providing a visual illustration to help make the semantics of each operation clear.</p>
...
<h2>1D Elements: Slicing and indexing<a class="headerlink" href="#d-elements-slicing-and-indexing" title="Link to this heading">#</a></h2>
...
<h2>2D and 3D Elements: slicing<a class="headerlink" href="#d-and-3d-elements-slicing" title="Link to this heading">#</a></h2>
...
<h2>2D Raster and Image: slicing and indexing<a class="headerlink" href="#d-raster-and-image-slicing-and-indexing" title="Link to this heading">#</a></h2>
...
<section class="tex2jax_ignore mathjax_ignore" id="tabular-indexing-and-slicing">
<h1>Tabular indexing and slicing<a class="headerlink" href="#tabular-indexing-and-slicing" title="Link to this heading">#</a></h1>
<p>While most indexing in HoloViews works by selecting the values along a dimension it is also frequently useful to index and slice using integer row and column indices. For this purpose most HoloViews objects have a <code class="docutils literal notranslate"><span class="pre">.iloc</span></code> indexing interface (mirroring the <a class="reference external" href="http://pandas.pydata.org/pandas-docs/stable/indexing.html#different-choices-for-indexing">pandas</a> API), which supports all the usual indexing semantics. Supported iloc arguments include:</p>
<ul class="simple">
<li><p>An integer e.g. 5</p></li>
<li><p>A list or array of integers [4, 3, 0]</p></li>
<li><p>A slice object with ints 1:7</p></li>
...
<div class="highlight-ipython3 notranslate"><div class="highlight"><pre><span></span><span class="n">xs</span> <span class="o">=</span> <span class="n">np</span><span class="o">.</span><span class="n">linspace</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="n">np</span><span class="o">.</span><span class="n">pi</span><span class="o">*</span><span class="mi">2</span><span class="p">,</span> <span class="mi">21</span><span class="p">)</span>
<span class="n">curve</span> <span class="o">=</span> <span class="n">hv</span><span class="o">.</span><span class="n">Curve</span><span class="p">((</span><span class="n">xs</span><span class="p">,</span> <span class="n">np</span><span class="o">.</span><span class="n">sin</span><span class="p">(</span><span class="n">xs</span><span class="p">)))</span>
<span class="nb">print</span><span class="p">(</span><span class="s1">&#39;x: </span><span class="si">%s</span><span class="s1">, y: </span><span class="si">%s</span><span class="s1">&#39;</span> <span class="o">%</span> <span class="p">(</span><span class="n">curve</span><span class="o">.</span><span class="n">iloc</span><span class="p">[</span><span class="mi">8</span><span class="p">,</span> <span class="mi">0</span><span class="p">],</span> <span class="n">curve</span><span class="o">.</span><span class="n">iloc</span><span class="p">[</span><span class="mi">8</span><span class="p">,</span> <span class="mi">1</span><span class="p">]))</span>
...
<h2>Lists of integers and boolean indices<a class="headerlink" href="#lists-of-integers-and-boolean-indices" title="Link to this heading">#</a></h2>
...
<h2>Sampling Elements<a class="headerlink" href="#sampling-elements" title="Link to this heading">#</a></h2>
...
<h2>Sampling HoloMaps<a class="headerlink" href="#sampling-holomaps" title="Link to this heading">#</a></h2>
...
<h2>Sampling Charts<a class="headerlink" href="#sampling-charts" title="Link to this heading">#</a></h2>
...
<p>These tools should help you index, slice, sample, and select your data with ease.  The <a class="reference internal" href="#./07-Tabular_Data.ipynb"><span class="xref myst">Tabular Data</span></a> guide explains how to do other types of operations, such as averaging and other reduction operations.</p>
</section>
</section>
