...
The fusion notebooks analyze **IS2SMGPSIT-V1**, a daily 25 km pan-Arctic sea ice thickness product generated by fusing ICESat-2 along-track thickness with SMOS/SMAP thin-ice thickness using Gaussian process regression (growth seasons, Sep–Apr). Data are hosted on AWS S3 as NetCDF/Zarr and loaded via `read_is2smgpsitv1_zarr()` in the book utilities.
